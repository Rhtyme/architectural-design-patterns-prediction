...
mvvm_keyword = '../Data/mvvm'
mvp_keyword = './Data/mvp'

pathlib.Path('../Data/mvvm/repos').mkdir(parents=True, exist_ok=True)

pathlib.Path('../Data/mvp/repos').mkdir(parents=True, exist_ok=True)
